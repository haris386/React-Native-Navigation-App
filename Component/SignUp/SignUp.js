                ...
                <View style={styles.bottomView}>
                    <View style={{ padding: 40 }}>
                        ...
                        <View style={{ marginTop: 10 }}>
                            ...
                            <Input variant="rounded"  placeholder="name" style={{ marginBottom: 10 }} />
                            ...
                            />
                            <Text style={{ color: 'black', fontWeight: 'bold', marginTop: 10 }}>Password</Text>
                            <Input
                                variant = "rounded"
                                w={{
                                    base: "100%",
                        ...
                        <Button 
                                endIcon={<Icon as={Ionicons} name="checkmark-done-circle-outline" size="md" />} style = {styles.loginBtn} onPress={() => navigation.navigate('Login')}
